            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <form action="<?= URLROOT ?>/planner/packages" method="POST" class="space-y-4" @submit="onSubmit">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Pickup Points (comma-separated)</label>
                            <input type="text" name="pickup_points" required placeholder="e.g., Central Station, North Gate, City Mall" class="w-full px-4 py-2 border rounded-xl outline-none focus:ring-2 focus:ring-eco-primary">
                        </div>
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div class="flex justify-between text-sm text-gray-500 mb-1">
                            <span>Pickup Points:</span> <span class="font-mono truncate ml-2"><?= htmlspecialchars($p->PickupPoints ?? 'None') ?></span>
                        </div>
